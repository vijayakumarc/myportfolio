...
const Hero = () => {
  return (
    <div className="border-b border-neutral-300 dark:border-neutral-700 pb-5 lg:mb-36">
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    <motion.h1 variants={container(0.5)} initial='hidden' animate='visible'  className="pb-16 text-6xl font-light tracking-tighter lg:mt-16 lg:text-8xl">VijayaKumar</motion.h1>
